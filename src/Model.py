...
class Model:
    ...
    def __init__(self, charList, decoderType=DecoderType.BestPath, mustRestore=False):
        ...
        self.optimizer = tf.train.RMSPropOptimizer(learning_rate=0.001,decay=0.9,momentum=0.0,epsilon=1e-07).minimize(self.loss)
        #2 self.optimizer = tf.train.AdamOptimizer(self.learningRate).minimize(self.loss)
