...
class Batch:
    """ Batching images and ground truth texts """
...
class DataLoader:
    ...
    def __init__(self, filePath, batchSize, imgSize, maxTextLen, load_aug=True):
        ...
        for line in f:
            ...
            # GT text columns start at 9.(Please check once in lines.txt file).
            ...
            # putting samples into list
            self.samples.append(Sample(gtText, fileName))


        # Displaying Bad Samples if any in the dataset
    ...
    def trainSet(self):
        "changing to randomly chosen subset of training set"
        self.dataAugmentation = True
        self.currIdx = 0
        random.shuffle(self.trainSamples) # shuffling the samples in each epoch
        self.samples = self.trainSamples

    def validationSet(self):
        "changing to validation set"
